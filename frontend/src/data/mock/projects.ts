...
export const MOCK_PROJECTS_SUMMARY = {
  projectCount: MOCK_PROJECT_ITEMS.length,
  totalMappings: MOCK_PROJECT_ITEMS.reduce((sum, project) => sum + project.totalMappings, 0),
  complete: MOCK_PROJECT_ITEMS.reduce((sum, project) => sum + project.completeCount, 0),
  inProgress: MOCK_PROJECT_ITEMS.reduce(
