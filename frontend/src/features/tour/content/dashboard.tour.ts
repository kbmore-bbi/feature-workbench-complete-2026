  ...
  steps: [
    {
      ...
      body: "After clicking 'Get Started', the user lands on the Dashboard. This screen provides an at-a-glance overview of all projects and mappings — including total counts, completion rates, and a list of recent mappings. The left-side panel allows navigation between Dashboard, Projects, and Mappings.",
      placement: "center",
      route: "/dashboard",
    },
    {
