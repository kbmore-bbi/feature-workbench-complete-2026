...
GRANT INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_PROJECT_ATTRIBUTES TO ROLE <APP_RUNTIME_ROLE>;
...
GRANT SELECT, INSERT, UPDATE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_AGENT_ARTIFACT_JOBS TO ROLE <APP_RUNTIME_ROLE>;
GRANT SELECT, INSERT, UPDATE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_WORKBENCH_ASYNC_JOBS TO ROLE <APP_RUNTIME_ROLE>;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_PREPARED_WORKSPACE_CONTEXTS TO ROLE <APP_RUNTIME_ROLE>;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_PREPARED_LEARNING_CONTEXTS TO ROLE <APP_RUNTIME_ROLE>;
...
GRANT CALLER SELECT, INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_SEMANTIC_BUNDLES TO ROLE <PROCEDURE_OWNER_ROLE>;
GRANT CALLER SELECT, INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_WORKSPACE_SNAPSHOTS TO ROLE <PROCEDURE_OWNER_ROLE>;
GRANT CALLER SELECT, INSERT, UPDATE, DELETE ON TABLE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.TBL_AGENT_ARTIFACTS TO ROLE <PROCEDURE_OWNER_ROLE>;
GRANT CALLER READ, WRITE ON STAGE <WORKBENCH_DB>.<WORKBENCH_SCHEMA>.<AGENT_ARTIFACT_STAGE> TO ROLE <PROCEDURE_OWNER_ROLE>;

-- Required by AI_COMPLETE / SNOWFLAKE.CORTEX.COMPLETE in caller-rights sessions.
GRANT DATABASE ROLE SNOWFLAKE.AI_FUNCTIONS_USER TO ROLE <APP_USER_ROLE>;
GRANT DATABASE ROLE SNOWFLAKE.AI_FUNCTIONS_USER TO ROLE <APP_RUNTIME_ROLE>;
GRANT DATABASE ROLE SNOWFLAKE.AI_FUNCTIONS_USER TO ROLE <PROCEDURE_OWNER_ROLE>;
GRANT USE AI FUNCTION AI_COMPLETE ON ACCOUNT TO ROLE <APP_USER_ROLE>;
GRANT USE AI FUNCTION AI_COMPLETE ON ACCOUNT TO ROLE <APP_RUNTIME_ROLE>;
GRANT USE AI FUNCTION AI_COMPLETE ON ACCOUNT TO ROLE <PROCEDURE_OWNER_ROLE>;
