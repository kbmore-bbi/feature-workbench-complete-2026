...
BEGIN
    CREATE OR REPLACE TEMPORARY TABLE TMP_FIR_RECOMMENDATION_STREAM_CONSUME (
        ROW_COUNT NUMBER
    );
    INSERT INTO TMP_FIR_RECOMMENDATION_STREAM_CONSUME
    SELECT COUNT(*)
    FROM __STTM_METADATA_NAMESPACE__.STM_FIR_RECOMMENDATIONS;
