...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Deploy the AGT_SEMANTIC_MODEL agent spec to Snowflake.")
    parser.add_argument(
        "--env-file",
    ...
    parser.add_argument(
        "--spec-file",
        default="infra/snowflake/agents/agent_spec_semantic_model.yaml",
        help="Path to the semantic agent spec YAML.",
    )
...
def main() -> None:
    ...
    statement = render_agent_statement("AGT_SEMANTIC_MODEL", spec_text, namespace)
    ...
    try:
        ...
        print(f"Deployed {namespace}.AGT_SEMANTIC_MODEL")
    finally:
        connection.close()
