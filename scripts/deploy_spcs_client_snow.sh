...
AUTO_MAPPING_POOL_MIN_NODES="${AUTO_MAPPING_POOL_MIN_NODES:-${AUTO_MAPPING_COMPUTE_POOL_MIN_NODES:-2}}"
...
AUTO_MAPPING_POOL_AUTO_SUSPEND_SECS="${AUTO_MAPPING_POOL_AUTO_SUSPEND_SECS:-${AUTO_MAPPING_COMPUTE_POOL_AUTO_SUSPEND_SECONDS:-3600}}"
