...
$ArtifactsDir = Join-Path $RootDir "artifacts\client-spcs-single-service"
...
Write-Host ""
Write-Host "Rendering single-service webapp spec to $RenderedSpec"
...
Write-Host ""
Write-Host "Single-service deployment complete."
Write-Host "Rendered spec: $RenderedSpec"
Write-Host "Auto-mapping remains in-process inside the backend container."
...
Write-Host "  3. Open the public endpoint from the command output and verify Snowflake sign-in"
